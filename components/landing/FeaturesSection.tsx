...
const features = [
  {
    ...
    description: "Intelligent forms that adapt based on user input, creating a natural conversation flow.",
    badge: "AI Powered",
    color: "bg-yellow-200",
  ...
  },
  {
    ...
    description: "Track completion rates and drop-offs with detailed, privacy-first analytics.",
    badge: "Insightful",
    color: "bg-green-200",
  ...
  },
  {
    ...
    description: "Start with professionally designed templates that you can customize to match your brand.",
    badge: "Creative",
    color: "bg-pink-200",
  ...
  },
  {
    ...
    description: "Connect seamlessly with your favorite tools including Slack, Notion, and Google Sheets.",
    badge: "Fast",
    color: "bg-blue-200",
  ...
  },
  {
    ...
    description: "Create complex branching paths without writing a single line of code.",
    badge: "Smart",
    color: "bg-orange-200",
  ...
  },
  {
    icon: Smartphone,
    title: "Mobile First",
    description: "Flawless experience on any device, ensuring you never miss a response.",
    badge: "Responsive",
    color: "bg-purple-200",
      ...
      <div className="container mx-auto px-6">
        <div className="mb-20 text-center space-y-4">
          ...
          <p className="text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto">
            We focused on the features that actually help you collect better data, not just feature bloat.
          </p>
        </div>
